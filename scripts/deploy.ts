...
import { OrdinalMarketplace } from '../src/contracts/ordinalMarketplace'
...
async function main() {
    await OrdinalMarketplace.compile()
    ...
    console.log('OrdinalMarketplace contract was successfully deployed!')
